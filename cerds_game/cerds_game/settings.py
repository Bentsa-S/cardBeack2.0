"""
Django settings for cerds_game project.
...
SECRET_KEY = 'django-insecure-j(-%v-tirk)*uh7nz4pd$cx2=avqs7648pl=ac86^!9#cz-=^0'
...
CORS_ALLOWED_ORIGINS = [
    ...
    config('URL_TO_OPEN_CROS', default='https://df41-194-44-136-166.ngrok-free.app')
]
...
ASGI_APPLICATION = 'cerds_game.asgi.application'
WSGI_APPLICATION = 'cerds_game.wsgi.application'
